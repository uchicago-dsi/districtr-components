...
const DistrictrThemeProvider = ({ children }) => {
    return React__namespace.createElement(styled.ThemeProvider, { theme: themeLight }, children);
};
...
const Button = (_a) => {
    ...
    if (href) {
        return (React__default["default"].createElement("a", { "data-testid": "Button", className: classes, id: id, href: href, role: role, "aria-label": accessibilityLabel, "aria-controls": ariaControls, "aria-expanded": ariaExpanded, "aria-describedby": ariaDescribedBy, "aria-checked": ariaChecked, onClick: onClick, onFocus: onFocus, onBlur: onBlur, onMouseEnter: onMouseEnter, onTouchStart: onTouchStart, onPointerDown: onPointerDown, tabIndex: disabled ? -1 : undefined, style: style }, children));
    }
    else {
        return (React__default["default"].createElement(DistrictrThemeProvider, null,
            React__default["default"].createElement(StyledButton, { "data-testid": "Button", className: classes, id: id, type: submit ? 'submit' : 'button', disabled: disabled, role: role, "aria-label": accessibilityLabel, "aria-controls": ariaControls, "aria-expanded": ariaExpanded, "aria-describedby": ariaDescribedBy, "aria-checked": ariaChecked, onClick: onClick, onFocus: onFocus, onBlur: onBlur, onMouseEnter: onMouseEnter, onTouchStart: onTouchStart, onPointerDown: onPointerDown, onKeyUp: onKeyUp, onKeyDown: onKeyDown, tabIndex: disabled ? -1 : undefined, style: style }, children)));
    }
};
...
const ColorPicker = ({ color, defaultUnitCount, onChange, onInput, onInputChange }) => {
    const [sources, setSources] = React__default["default"].useState(['districtr', 'cartoColors', 'colorBrewer']);
    const [unitCount, setUnitCount] = React__default["default"].useState(defaultUnitCount);
    const [activeSchemeSource, setActiveSchemeSource] = React__default["default"].useState('districtr');
    const [activeScheme, setActiveScheme] = React__default["default"].useState('Core');
    const [activeSchemeGroup, setActiveSchemeGroup] = React__default["default"].useState('All');
    const [schemeGroups, setSchemeGroups] = React__default["default"].useState([]);
    const [colorSchemes, setColorSchemes] = React__default["default"].useState([]);
    const [sourceFilter, setSourceFilter] = React__default["default"].useState('All');
    const [filteredColorSchemes, setFilteredColorSchemes] = React__default["default"].useState([]);
    const [activeColorScheme, setActiveColorScheme] = React__default["default"].useState([]);
    const [activeColor, setActiveColor] = React__default["default"].useState(color);
    const [hexInput, setHexInput] = React__default["default"].useState(color);
    ...
    return (React__default["default"].createElement(DistrictrThemeProvider, null,
        React__default["default"].createElement(ColorPickerWrapper, { "data-testid": "ColorPicker", className: "d-colorpicker" },
            React__default["default"].createElement("div", { className: "d-panel-section" },
                React__default["default"].createElement("input", { ref: inputRef, className: "d-panel-input", type: "text", name: "hex", value: hexInput, onInput: handleHexInput })),
            React__default["default"].createElement("div", { className: "d-colorpicker-color", "data-testid": "ColorPickerDisplay", style: { backgroundColor: activeColor } }),
            React__default["default"].createElement("div", { className: "d-panel-section" },
                React__default["default"].createElement("ul", { className: "d-swatchpicker" }, activeColorScheme.map((color, index) => {
                    return (React__default["default"].createElement("li", { key: index, className: "d-swatchpicker-swatch" },
                        React__default["default"].createElement(Button, { "aria-label": "Color Swatch", pressed: activeColor === color, variant: 'swatch', style: { backgroundColor: color }, "dataset-color": color, 
                            //@ts-ignore
                            onClick: (e) => handleSwatchClick(e, color) })));
                }))),
            React__default["default"].createElement("hr", null),
            React__default["default"].createElement("div", { className: "d-panel-section d-scheme-filters" },
                React__default["default"].createElement("div", { className: "d-panel-col" },
                    React__default["default"].createElement("select", { className: 'd-panel-input', value: sourceFilter, onChange: (e) => setSourceFilter(e.target.value) },
                        React__default["default"].createElement("option", { value: "All" }, "All"),
                        sources.map((schemeSource) => {
                            return (React__default["default"].createElement("option", { key: schemeSource, value: schemeSource }, schemeSource));
                        }))),
                React__default["default"].createElement("div", { className: "d-panel-col" },
                    React__default["default"].createElement("select", { className: 'd-panel-input', value: activeSchemeGroup, onChange: handleSchemeGroupChange }, schemeGroups.map((schemeGroup) => {
                        return (React__default["default"].createElement("option", { key: schemeGroup, value: schemeGroup }, schemeGroup));
                    }))),
                React__default["default"].createElement("div", { className: "d-panel-col" },
                    React__default["default"].createElement("input", { className: 'd-panel-input', type: "number", min: "1", max: "435", value: unitCount, onChange: (e) => setUnitCount(parseInt(e.target.value)) }))),
            React__default["default"].createElement("ul", { className: "d-panel-list" }, filteredColorSchemes.map((colorScheme) => {
                return (React__default["default"].createElement("li", { key: colorScheme.id, "data-source": colorScheme.source, "data-scheme": colorScheme.value, onClick: handleSchemeClick, className: "d-list-item d-scheme-item" },
                    React__default["default"].createElement("div", { className: "d-scheme-info" },
                        React__default["default"].createElement("div", { className: "d-scheme-title" }, colorScheme.label),
                        React__default["default"].createElement("div", { className: "d-scheme-groups" }, colorScheme.groups.toString())),
                    React__default["default"].createElement("div", { className: "d-scheme-colors" }, colorScheme.colors.map((color, index) => {
                        return React__default["default"].createElement("div", { className: "d-scheme-color", key: index, style: { backgroundColor: color } });
                    }))));
            })))));
};
...
const DistrictrContext = React.createContext(null);
const DistrictrDispatchContext = React.createContext(null);

const StyledCursor = styled__default["default"].div `
  position: absolute;
  top: 0;
  left: 0;
  width: 1px;
...
`;
const CursorBounds = styled__default["default"].div `
  width: 100%;
  height: 100%;
  border-radius: 50%;
  border: 2px solid #333333;
...
`;
const CursorCenter = styled__default["default"].div `
  position: relative;
  top: calc(-50% - 4px);
  left: calc(50% - 4px);
  width: 8px;
...
const Cursor = ({ position }) => {
    if (!position)
        return null;
    const districtr = React__default["default"].useContext(DistrictrContext);
    const districtrDispatch = React__default["default"].useContext(DistrictrDispatchContext);
    const cursorCircle = React__default["default"].useRef(null);
    const cursorDot = React__default["default"].useRef(null);
    React.useEffect(() => {
    ...
    return (React__default["default"].createElement(StyledCursor, { "data-testid": "Cursor", className: `d-cursor-${districtr.activeTool.toLowerCase()} d-cursor--${districtr.cursorVisible ? 'visible' : 'hidden'}`, style: {
            top: position.y + 50,
            left: position.x + 48,
            width: getSideLength(districtr.brushSize * 2),
            height: getSideLength(districtr.brushSize * 2)
        } },
        React__default["default"].createElement(CursorBounds, { ref: cursorCircle, className: `d-brush-${districtr.activeTool}` }),
        React__default["default"].createElement(CursorCenter, { ref: cursorDot })));
};
...
const LayerControl = ({ map, layer }) => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    React__default["default"].useContext(DistrictrDispatchContext);
    const [open, setOpen] = React__default["default"].useState(false);
    const [layerName, setLayerName] = React__default["default"].useState(null);
    const [layerTypeName, setLayerTypeName] = React__default["default"].useState(null);
    const [visible, setVisible] = React__default["default"].useState(true);
    const [opacity, setOpacity] = React__default["default"].useState(1);
    const [fillColor, setFillColor] = React__default["default"].useState(null);
    const [strokeColor, setStrokeColor] = React__default["default"].useState(null);
    const [strokeWidth, setStrokeWidth] = React__default["default"].useState(null);
    const [originalPaintProperties, setOriginalPaintProperties] = React__default["default"].useState(null);
    const [originalLayoutProperties, setOriginalLayoutProperties] = React__default["default"].useState(null);
    ...
    React__default["default"].useEffect(() => { }, [open]);
    ...
    return (React__default["default"].createElement("li", { "data-testid": "LayerControl", className: "layer-control-panel" },
        React__default["default"].createElement("div", { className: "layer-control-panel__header" },
            React__default["default"].createElement(Button, { accessibilityLabel: "Open", size: "small", pressed: open, variant: "toggle", onClick: () => setOpen(!open) }, "\u271A"),
            React__default["default"].createElement("div", { className: "layer-control-panel__title" },
                layerName,
                " (",
                layerTypeName,
                ")"),
            React__default["default"].createElement("div", { className: "layer-control-panel__quick-actions" },
                React__default["default"].createElement(Button, { accessibilityLabel: "visible", size: "small", variant: "toggle", onClick: () => toggleVisibility() }, visible ? React__default["default"].createElement(bi.BiShow, null) : React__default["default"].createElement(bi.BiHide, null)))),
        React__default["default"].createElement("div", { className: `layer-control-panel__content ${open ? ' layer-control-panel__open' : ''}` },
            React__default["default"].createElement("div", { className: "layer-control-panel__content__inner" },
                React__default["default"].createElement("div", { className: "layer-control-panel__content__inner__row" },
                    React__default["default"].createElement("label", { htmlFor: "visibility" }, "Visibility"),
                    React__default["default"].createElement("input", { id: "visibility", type: "checkbox", checked: visible, onChange: toggleVisibility })),
                React__default["default"].createElement("div", { className: "layer-control-panel__content__inner__row" },
                    React__default["default"].createElement("label", { htmlFor: "opacity" }, "Opacity"),
                    React__default["default"].createElement("input", { id: "opacity", type: "range", min: "0", max: "1", step: "0.05", value: opacity, onChange: (e) => {
                ...
                originalPaintProperties && originalPaintProperties.fill && (React__default["default"].createElement("div", { className: "layer-control-panel__content__inner__row" },
                    React__default["default"].createElement("label", { htmlFor: "fill-color" }, "Fill Color"),
                    React__default["default"].createElement("input", { id: "fill-color", type: "color", value: fillColor, onChange: (e) => {
                            const value = e.target.value;
                            setFillColor(value);
                            map.setPaintProperty(layer.id, 'fill-color', value);
                        } }))),
                originalPaintProperties && originalPaintProperties.stroke && (React__default["default"].createElement("div", { className: "layer-control-panel__content__inner__row" },
                    React__default["default"].createElement("label", { htmlFor: "stroke-color" }, "Stroke Color"),
                    React__default["default"].createElement("input", { id: "stroke-color", type: "color", value: strokeColor, onChange: (e) => {
                            const value = e.target.value;
                            setStrokeColor(value);
                            map.setPaintProperty(layer.id, 'line-color', value);
                        } }))),
                originalPaintProperties && originalPaintProperties.stroke && (React__default["default"].createElement("div", { className: "layer-control-panel__content__inner__row" },
                    React__default["default"].createElement("label", { htmlFor: "stroke-width" }, "Stroke Width"),
                    React__default["default"].createElement("input", { id: "stroke-width", type: "range", min: "0", max: "10", step: "0.5", value: strokeWidth, onChange: (e) => {
                            const value = parseFloat(e.target.value);
...
const DebugPanel = ({ map }) => {
    const [mapLayers, setMapLayers] = React__default["default"].useState(null);
    const [mapGroups, setMapGroups] = React__default["default"].useState(null);
    React.useEffect(() => {
        if (map) {
    ...
    return (React__default["default"].createElement("div", { "data-testid": "DebugPanel", className: "d-debug-panel d-debug-panel--scrollable " },
        React__default["default"].createElement("div", { className: "d-debug-panel__content" },
            React__default["default"].createElement("div", { className: "d-debug-panel__section" },
                React__default["default"].createElement("h4", { style: { marginBottom: 5 } }, "Layer Control"),
                React__default["default"].createElement("ul", { className: "d-debug-panel__list" }, mapLayers && mapGroups && (React__default["default"].createElement(React__default["default"].Fragment, null, mapGroups.map((group) => (React__default["default"].createElement("li", { key: group, className: "d-debug-panel__list-item" },
                    React__default["default"].createElement("h5", null, group),
                    React__default["default"].createElement("ul", { className: "d-debug-panel__list" }, mapLayers.map((layer) => {
                        if (!layer.metadata && group === 'Districtr') {
                            return React__default["default"].createElement(LayerControl, { key: layer.id, map: map, layer: layer });
                        }
                    }))))))))))));
};

const StyledSplitStitcher = styled__default["default"].div `
  position: absolute;
  top: 50px;
  bottom: 0;
  right: 48px;
...
const SplitStitcher = ({ foo }) => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    const districtrDispatch = React__default["default"].useContext(DistrictrDispatchContext);
    const [splits, setSplits] = React__default["default"].useState(new Map());
    const [totalFeatures, setTotalFeatures] = React__default["default"].useState(9178);
    const [drawnFeatures, setDrawnFeatures] = React__default["default"].useState(0);
    React__default["default"].useEffect(() => {
        calculateSplits();
    }, []);
    React__default["default"].useEffect(() => {
    ...
    return (React__default["default"].createElement(StyledSplitStitcher, { "data-testid": "SplitStitcher" },
        React__default["default"].createElement("h4", null, "Stitch Split Counties"),
        React__default["default"].createElement("small", null, "Paint by County will only paint counties that are in view. The map's bounds will be locked while drawing by county."),
        React__default["default"].createElement("br", null),
        React__default["default"].createElement("div", { style: { marginTop: 12 } },
            React__default["default"].createElement(Button, { accessibilityLabel: "Paint By County", pressed: districtr.paintByCounty, fullWidth: true, variant: "secondary", onClick: togglePaintByCounty }, districtr.paintByCounty ? 'Turn Off Paint By County' : 'Turn On Paint By County')),
        React__default["default"].createElement("br", null),
        React__default["default"].createElement("ul", { style: { listStyle: 'none', padding: 0 } },
            ...
            React__default["default"].createElement("div", null,
                React__default["default"].createElement(Button, { accessibilityLabel: "Recalculate", fullWidth: true, onClick: calculateSplits }, "Recalculate"),
                React__default["default"].createElement("br", null),
...
const StyledRange = styled__default["default"].input `
...
`;
const StyledRangeSlider = styled__default["default"].div `
  display: flex;
...
const RangeSlider = ({ align, min, max, name }) => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    const districtrDispatch = React__default["default"].useContext(DistrictrDispatchContext);
    const rangeSlider = React__default["default"].useRef(null);
    const rangeInput = React__default["default"].useRef(null);
    const range = React__default["default"].useRef(null);
    const handleChange = (e) => {
        districtrDispatch({ type: 'set_brush_size', payload: parseInt(e.target.value) });
    };
    return (React__default["default"].createElement(StyledRangeSlider, { ref: rangeSlider, "data-testid": "RangeSlider", className: `d-rangeslider d-rangeslider--${align}` },
        React__default["default"].createElement(StyledInput, { name: name, ref: rangeInput, type: "number", value: districtr.brushSizeValue, min: min, onChange: handleChange, max: max, className: "d-input-number" }),
        React__default["default"].createElement(StyledRange, { name: name, ref: range, type: "range", min: min, max: max, value: districtr.brushSizeValue, onChange: handleChange, className: "d-range" })));
};
...
const Toolbar = ({ position, children }) => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    const districtrDispatch = React__default["default"].useContext(DistrictrDispatchContext);
    const [panelOpen, setPanelOpen] = React__default["default"].useState(false);
    const [currentColor, setCurrentColor] = React__default["default"].useState(null);
    const [unitCount, setUnitCount] = React__default["default"].useState(Object.keys(districtr.units).length);
    React__default["default"].useEffect(() => {
    ...
    React__default["default"].useEffect(() => { }, [currentColor]);
    ...
    const createToolButtons = () => {
        ...
        for (const [key, value] of Object.entries(districtr.tools)) {
            ...
            const icon = () => {
                if (tool.name === 'brush') {
                    return React__default["default"].createElement(bi.BiBrush, null);
                }
                else if (tool.name === 'eraser') {
                    return React__default["default"].createElement(bi.BiEraser, null);
                }
                else if (tool.name === 'pan') {
                    return React__default["default"].createElement(bi.BiMove, null);
                }
                else {
                    return tool.icon;
                }
            ...
            if (tool.enabled) {
                toolButtons.push(React__default["default"].createElement("li", { key: key, className: "d-toolbar-item" },
                    React__default["default"].createElement(Button, { accessibilityLabel: `${tool.name} button`, variant: 'toolbar', pressed: districtr.activeTool === tool.name, onClick: () => handleToolChange(tool.name) }, icon())));
            }
        }
        return toolButtons;
    };
            ...
            if (tool.name === districtr.activeTool && tool.enabled && 'options' in tool) {
                ...
                optionInputs.forEach((optionInput, index) => {
                    if (optionInput.type === 'rangeSlider') {
                        toolOptions.push(React__default["default"].createElement("li", { key: index, className: "d-toolbar-item" },
                            React__default["default"].createElement(RangeSlider, Object.assign({}, optionInput.config, { onChange: handleOptionChange, name: optionInput.property }))));
                    }
                    if (optionInput.type === 'colorPicker') {
                        if (!districtr.units)
                            return null;
                        toolOptions.push(React__default["default"].createElement("li", { key: index, className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Color Swatch", variant: 'swatch', onClick: () => (panelOpen === index ? setPanelOpen(false) : setPanelOpen(index)), style: { backgroundColor: currentColor } }),
                            panelOpen === index && (React__default["default"].createElement("div", { className: "d-panel d-toolbar-panel" },
                                React__default["default"].createElement(ColorPicker, { color: currentColor, defaultUnitCount: unitCount, onChange: handleColorChange })))));
                    }
                });
            }
        }
    ...
    return (React__default["default"].createElement("div", { "data-testid": "Toolbar", className: `d-toolbar d-toolbar--${position}` },
        districtr.tools && position == 'left' && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("ul", { className: "d-toolbar-group d-toolbar-group--top" }, toolButtons),
            React__default["default"].createElement("ul", { className: "d-toolbar-group d-toolbar-group--middle" }, toolOptions))),
        children));
};

const StyledTableController = styled__default["default"].div `
  padding: 0;
  background: transparent;
  color: ${(props) => props.theme.foreground};
  padding-bottom: 10px;
  margin-bottom: 10px;
`;
const StyledTableItem = styled__default["default"].div `
  display: grid;
...
styled__default["default"].div `
  ...
  grid-area: 1 / 1 / 2 / 5;
`;
const TableItemCell = styled__default["default"].div `
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: ${(props) => props.theme.type.fontSize['md']};
...
const TableControllerItem = ({ item, total, activeValue, setActiveValue }) => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    const districtrDispatch = React__default["default"].useContext(DistrictrDispatchContext);
    const [activeValues, setActiveValues] = React__default["default"].useState([]);
    const [activeHeaderLabel, setActiveHeaderLabel] = React__default["default"].useState(['District', 'District']);
    const [open, setOpen] = React__default["default"].useState(false);
    const [datasetShareValue, setDatasetShareValue] = React__default["default"].useState('');
    const [datasetShareValueRaw, setDatasetShareValueRaw] = React__default["default"].useState('0');
    React__default["default"].useEffect(() => {
    ...
    return (React__default["default"].createElement(StyledTableItem, { "data-testid": "TableController" },
        React__default["default"].createElement(TableItemCell, { className: "toggle-wrapper" },
            React__default["default"].createElement(Button, { accessibilityLabel: "Toggle Open", pressed: open, variant: "toggle", onClick: () => setOpen(!open) },
                React__default["default"].createElement(bi.BiChevronRight, null))),
        React__default["default"].createElement(TableItemCell, { className: "cell-name" }, item.name),
        React__default["default"].createElement(TableItemCell, { onClick: changeActiveValue, className: "cell-value" },
            districtr.activeDemoOverlay === item.key && React__default["default"].createElement(bi.BiMapAlt, null),
            districtr.activeDemoLabel === item.key && React__default["default"].createElement(md.MdOutlineLabel, null),
            activeValues[activeValue]),
        open && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(TableItemCell, { className: "cell-wrapper" },
                React__default["default"].createElement("div", { className: "cell-controls" },
                    React__default["default"].createElement(Button, { accessibilityLabel: "Demographic Overlay", pressed: districtr.activeDemoOverlay === item.key, size: "small", variant: "toolbar", style: { marginRight: 4 }, onClick: handleOverlayClick },
                        React__default["default"].createElement(bi.BiMapAlt, null)),
                    React__default["default"].createElement(Button, { accessibilityLabel: "Demographic Labels", pressed: districtr.activeDemoLabel === item.key, size: "small", variant: "toolbar", style: { marginRight: 4 }, onClick: handleLabelClick },
                        React__default["default"].createElement(md.MdOutlineLabel, null))),
                React__default["default"].createElement("div", { className: "cell-state_left" },
                    activeValue == 1 ? activeHeaderLabel[0] : activeHeaderLabel[1],
                    React__default["default"].createElement("br", null),
                    activeValue == 1 ? activeValues[0] : activeValues[1]),
                React__default["default"].createElement("div", { className: "cell-state_right" },
                    "State",
                    React__default["default"].createElement("br", null),
...
const TableController = ({ data, activeSet }) => {
    const [activeValue, setActiveValue] = React__default["default"].useState(0);
    const [chartData, setChartData] = React__default["default"].useState([]);
    const [chartTotal, setChartTotal] = React__default["default"].useState(null);
    React.useEffect(() => { }, [activeValue]);
    if (!data)
        return null;
    React__default["default"].useEffect(() => {
    ...
    return (React__default["default"].createElement(DistrictrThemeProvider, null,
        React__default["default"].createElement(StyledTableController, { "data-testid": "TableController" },
            chartData.map((item, index) => {
                return (React__default["default"].createElement(TableControllerItem, { key: index, item: item, total: chartTotal, activeValue: activeValue, setActiveValue: setActiveValue }));
            }),
            React__default["default"].createElement(Button, { accessibilityLabel: "Coalition Builder", variant: "secondary", fullWidth: true },
                ' ',
                "+ Add Custom Coalition"))));
};

const UnitControllerWrapper = styled__default["default"].div`
  display: flex;
  flex-direction: column;
  justify-content: space-between;
  align-items: flex-start;
...
const UnitHeader = styled__default["default"].div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
...
const UnitPagerTitle = styled__default["default"].h4`
  margin: 0;
`;

const UnitInformation = styled__default["default"].div`
  ...
  padding: 8px;
`;
const UnitColor = styled__default["default"].div`
  width: 64px;
  height: 56px;
  border-radius: 3px;
  border: 2px solid #333333;
...
const UnitDetails = styled__default["default"].div`
  width: 100%;
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
...
const UnitOptionsRow = styled__default["default"].div`
  display: flex;
  flex-direction: row;
  justify-content: flex-start;
  align-items: center;
...
const DatasetPickerWrapper = styled__default["default"].div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
...
const DatasetPicker = styled__default["default"].select`
  width: 100%;
  padding: 3px 8px;
  font-size: 12px;
  font-weight: 700;
...
const GhostInput = styled__default["default"].input`
...
const UnitNotePadWrapper = styled__default["default"].div`
  width: 100%;
  height: 100%;
  padding: 8px;
  display: flex;
...
const UnitNotePad = styled__default["default"].textarea`
  width: 100%;
  height: 100%;
  padding: 8px;
  font-size: 12px;
...
const PopulationWrapper = styled__default["default"].div`
  width: 100%;
  height: 100%;
  padding: 0 8px;
  display: flex;
...
const PopulationLabel = styled__default["default"].label`
  font-size: 10px;
`;

const PopulationValue = styled__default["default"].div`
  font-size: 16px;
  font-weight: 700;
`;
...
const UnitController = ({ dataSets, activeDataSet, setActiveDataSet }) => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    const districtrDispatch = React__default["default"].useContext(DistrictrDispatchContext);
    const [showNotes, setShowNotes] = React__default["default"].useState(false);
    ...
    return (React__default["default"].createElement(UnitControllerWrapper, { "data-testid": "UnitController" },
        React__default["default"].createElement(UnitHeader, null,
            React__default["default"].createElement(Button, { variant: "toolbar", onClick: () => changeActiveUnit('previous'), style: { border: 'none' } },
                React__default["default"].createElement(fa.FaArrowCircleLeft, null)),
            React__default["default"].createElement("div", null,
                React__default["default"].createElement(UnitPagerTitle, null,
                    districtr.activeUnit,
                    " of ",
                    Object.keys(districtr.units).length)),
            React__default["default"].createElement(Button, { variant: "toolbar", onClick: () => changeActiveUnit('next'), style: { border: 'none' } },
                React__default["default"].createElement(fa.FaArrowCircleRight, null))),
        React__default["default"].createElement(UnitInformation, null,
            React__default["default"].createElement(UnitColor, { style: { backgroundColor: districtr.units[districtr.activeUnit].color } }),
            React__default["default"].createElement(UnitDetails, null,
                React__default["default"].createElement(InputWrapper, null,
                    React__default["default"].createElement(GhostInput, { type: "text", value: districtr.units[districtr.activeUnit].name, onChange: (e) => {
                            handleTextInputChange(e);
                        } })),
                React__default["default"].createElement(UnitOptionsRow, null,
                    React__default["default"].createElement(Button, { pressed: districtr.lockedUnits.has(districtr.activeUnit), size: "small", variant: "toolbar", onClick: handleUnitLockChange, style: { marginRight: 4 } }, districtr.lockedUnits.has(districtr.activeUnit) ? React__default["default"].createElement(bi.BiLock, null) : React__default["default"].createElement(bi.BiLockOpen, null)),
                    React__default["default"].createElement(Button, { pressed: districtr.hiddenUnits.has(districtr.activeUnit), size: "small", variant: "toolbar", onClick: handleUnitVisibilityChange, style: { marginRight: 4 } }, districtr.hiddenUnits.has(districtr.activeUnit) ? React__default["default"].createElement(bi.BiHide, null) : React__default["default"].createElement(bi.BiShowAlt, null)),
                    React__default["default"].createElement(Button, { pressed: showNotes, size: "small", variant: "toolbar", onClick: () => setShowNotes(!showNotes), style: { marginRight: 4 } },
                        React__default["default"].createElement(bi.BiNote, null)),
                    React__default["default"].createElement(DatasetPickerWrapper, null,
                        React__default["default"].createElement(DatasetPicker, { onChange: (e) => setActiveDataSet(e.target.value) }, dataSets.map((d) => (React__default["default"].createElement("option", { key: d, value: d }, d)))))))),
        showNotes && (React__default["default"].createElement(UnitNotePadWrapper, null,
            React__default["default"].createElement("label", { htmlFor: "notes" }, "Unit Notes"),
            React__default["default"].createElement(UnitNotePad, { name: "notes", value: districtr.units[districtr.activeUnit].note, onChange: (e) => handleNoteChange(e) }))),
        React__default["default"].createElement(PopulationWrapper, null,
            React__default["default"].createElement("div", null,
                React__default["default"].createElement(PopulationLabel, null, "Population"),
                React__default["default"].createElement(PopulationValue, null, districtr.units[districtr.activeUnit].population.toLocaleString())),
            React__default["default"].createElement("div", null,
                React__default["default"].createElement(PopulationLabel, null, "+/- Ideal"),
                React__default["default"].createElement(PopulationValue, null, getPopulationVariance())),
            React__default["default"].createElement("div", null,
                React__default["default"].createElement(PopulationLabel, null, "Ideal"),
                React__default["default"].createElement(PopulationValue, null, districtr.units[districtr.activeUnit].unitIdealPopulation.toLocaleString())))));
};
...
const UnitPopulationChart = ({ unitId, variant = 'default' }) => {
    ...
    return (React__default["default"].createElement(ChartWrapper, { style: { width: '100%', height: 48, marginBottom: marginBottom }, onClick: (e) => handleChartClick() },
        React__default["default"].createElement(responsive.ParentSize, null, (parent) => (React__default["default"].createElement("svg", { width: parent.width, height: parent.height },
            React__default["default"].createElement("rect", { width: parent.width, height: parent.height, fill: "transparent" }),
            React__default["default"].createElement(group.Group, { top: 18 },
                React__default["default"].createElement("rect", { key: `background`, x: 0, y: 0, height: parent.height, width: parent.width, fill: '#eeeeee' }),
                React__default["default"].createElement(shape.BarStackHorizontal, { data: chartData, keys: keys, height: parent.height - 18, width: parent.width, y: (d) => d.name, xScale: scale.scaleLinear({
                    ...
                    }) }, (barStacks) => barStacks.map((barStack) => barStack.bars.map((bar) => (React__default["default"].createElement("rect", { key: `bar-stack-${barStack.index}-${bar.index}`, x: bar.x, y: bar.y, height: bar.height, width: bar.width, fill: bar.color }))))),
                React__default["default"].createElement(axis.AxisTop, { top: 0, scale: scale.scaleLinear({
                        range: [0, parent.width],
                        domain: [0, 120]
                ...
                Array.from(Array(members).keys()).map((member, i) => {
                    ...
                    return (React__default["default"].createElement(shape.Line, { key: `member-${i}`, from: {
                            x: scale.scaleLinear({
                                domain: [0, 120],
                                range: [0, parent.width]
                            })((100 / members) * (i + 1)),
                ...
                getChartStatus() === 'danger' && (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement("rect", { key: `background`, x: 0, y: 0, height: parent.height, width: parent.width, fill: variant === 'default' ? '#a60000' : `${unit.hoverColor}` }),
                    React__default["default"].createElement("text", { key: `bar-stack-text`, style: { fontWeight: 'bold' }, x: parent.width / 2, y: parent.height / 2 - 5, textAnchor: "middle", fill: "#ffffff" },
                        "OVER +",
                        Math.round((unit.population / unit.unitIdealPopulation) * 100 - 100) + '%'))),
                React__default["default"].createElement(shape.Line, { from: {
                        x: scale.scaleLinear({
                            domain: [0, 120],
                            range: [0, parent.width]
                        })(0),
...
const UnitPropertiesContainer = styled__default["default"].div `
  position: absolute;
  top: 50px;
  right: 48px;
  width: 300px;
...
const UnitProperties = () => {
    const districtr = React__default["default"].useContext(DistrictrContext);
    React__default["default"].useContext(DistrictrDispatchContext);
    const [dataSets, setDataSets] = React__default["default"].useState(['Population', 'Civilian Voting Age Population']);
    const [activeDataSet, setActiveDataSet] = React__default["default"].useState('Population');
    const [showPanel, setShowPanel] = React__default["default"].useState('');
    const [allUnitData, setAllUnitData] = React__default["default"].useState(null);
    const [allData, setAllData] = React__default["default"].useState(null);
    const [chartData, setChartData] = React__default["default"].useState(null);
    const [allSubgroupChartData, setAllSubgroupChartData] = React__default["default"].useState(null);
    const [subgroupChartData, setSubgroupChartData] = React__default["default"].useState(null);
    const [keys, setKeys] = React__default["default"].useState(null);
    React__default["default"].useEffect(() => {
        if (!districtr.mapboxMap) {
            return;
        }
    ...
    return (React__default["default"].createElement(UnitPropertiesContainer, { "data-testid": "UnitProperties" },
        React__default["default"].createElement(UnitController, { dataSets: dataSets, activeDataSet: activeDataSet, setActiveDataSet: setActiveDataSet }),
        React__default["default"].createElement("div", { style: { padding: '0 8px' } },
            React__default["default"].createElement(UnitPopulationChart, { key: districtr.units[districtr.activeUnit].id, unitId: districtr.activeUnit })),
        React__default["default"].createElement("div", { style: {
            ...
            React__default["default"].createElement(Button, { accessibilityLabel: "All Units", fullWidth: true, variant: "secondary", pressed: showPanel === 'all', onClick: () => (showPanel === 'all' ? setShowPanel('') : setShowPanel('all')) }, "All Units"),
            "\u00A0",
            React__default["default"].createElement(Button, { accessibilityLabel: "Demographics", fullWidth: true, variant: "secondary", pressed: showPanel === 'demographics', onClick: () => (showPanel === 'demographics' ? setShowPanel('') : setShowPanel('demographics')) }, "Demographics")),
        React__default["default"].createElement("div", { style: {
                marginTop: 12,
                width: '100%',
                padding: '8px',
            ...
            showPanel === 'demographics' && React__default["default"].createElement(TableController, { data: subgroupChartData, activeSet: activeDataSet }),
            showPanel === 'all' &&
                districtr.units &&
                Object.keys(districtr.units).map((unit) => {
                    if (districtr.units[unit].population > 1) {
                        return React__default["default"].createElement(UnitPopulationChart, { key: `population-chart-${unit}`, unitId: unit, variant: "allUnits" });
                    }
                }))));
};
...
const DistrictrWrapper = styled__default["default"].div `
  width: 100%;
  height: 100%;
  flex-grow: 1;
  display: flex;
...
const Districtr = ({ mapboxContainerId = 'districtr-mapbox', title = 'Districtr Map', mapboxAccessToken, initialViewState = {
    ...
    const mapStyleOptions = React.useRef(defaultMapStyleConfig);
    const mapboxContainerRef = React.useRef(null);
    const [districtr, districtrDispatch] = React.useReducer(districtrReducer, {
        mapboxMap: null,
    ...
    const [rightPanel, setRightPanel] = React.useState('unit');
    const [currentSave, setCurrentSave] = React.useState(null);
    const [saveLoaded, setSaveLoaded] = React.useState(false);
    ...
    return (React__default["default"].createElement(DistrictrThemeProvider, null,
        React__default["default"].createElement(DistrictrContext.Provider, { value: districtr },
            React__default["default"].createElement(DistrictrDispatchContext.Provider, { value: districtrDispatch }, districtr && (React__default["default"].createElement(DistrictrWrapper, { "data-testid": "Districtr", className: "districtr-wrapper" },
                React__default["default"].createElement(Toolbar, { position: 'left' },
                    React__default["default"].createElement("ul", { className: "d-toolbar-group d-toolbar-group--bottom" },
                        React__default["default"].createElement("li", { className: "d-toolbar-item" }))),
                React__default["default"].createElement("div", { id: "districtr-mapbox", className: "districtr-mapbox", ref: mapboxContainerRef }),
                React__default["default"].createElement(Cursor, { visible: districtr.cursorVisible, size: districtr.brushSize, tool: districtr.activeTool, position: mousePosition.current }),
                React__default["default"].createElement(Toolbar, { position: 'right' },
                    React__default["default"].createElement("ul", { className: "d-toolbar-group d-toolbar-group--top" },
                        React__default["default"].createElement("li", { className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Zoom In", variant: "toolbar", onClick: () => districtr.mapboxMap.zoomIn({ duration: 200 }) },
                                React__default["default"].createElement(bi.BiZoomIn, null))),
                        React__default["default"].createElement("li", { className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Zoom Out", variant: "toolbar", onClick: () => districtr.mapboxMap.zoomOut({ duration: 200 }) },
                                React__default["default"].createElement(bi.BiZoomOut, null))),
                        React__default["default"].createElement("li", { className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Pan To Bounds", variant: "toolbar", onClick: () => {
                                    if (districtr.mapboxMap) {
                                        districtr.mapboxMap.fitBounds(initialViewState.bounds, { duration: 200 });
                                    }
                                } },
                                React__default["default"].createElement(hi.HiArrowsExpand, null)))),
                    React__default["default"].createElement("ul", { className: "d-toolbar-group d-toolbar-group--bottom" },
                        React__default["default"].createElement("li", { className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Unit Properties", variant: "toolbar", pressed: rightPanel === 'unit', onClick: () => (rightPanel === 'unit' ? setRightPanel('') : setRightPanel('unit')) },
                                React__default["default"].createElement(rx.RxGroup, null))),
                        React__default["default"].createElement("li", { className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Layer Control", variant: "toolbar", pressed: rightPanel === 'debug', onClick: () => (rightPanel === 'debug' ? setRightPanel('') : setRightPanel('debug')) },
                                React__default["default"].createElement(rx.RxLayers, null))),
                        React__default["default"].createElement("li", { className: "d-toolbar-item" },
                            React__default["default"].createElement(Button, { accessibilityLabel: "Stitch Tool", variant: "toolbar", pressed: rightPanel === 'stitch', onClick: () => (rightPanel === 'stitch' ? setRightPanel('') : setRightPanel('stitch')) },
                                React__default["default"].createElement(gi.GiSewingNeedle, null)))),
                    React__default["default"].createElement("ul", { className: "d-toolbar-group d-toolbar-group--bottom" })),
                rightPanel === 'debug' && (React__default["default"].createElement(DebugPanel, { map: districtr.mapboxMap, layers: districtr.layers, units: districtr.units, activeUnit: districtr.activeUnit, sumPopulation: districtr.populationSum, title: title })),
                rightPanel === 'unit' && React__default["default"].createElement(UnitProperties, null),
                rightPanel === 'stitch' && React__default["default"].createElement(SplitStitcher, { foo: 'foo' })))))));
};
