export default {
  ...
  colorBrewer: {
    ...
    name: 'Color Brewer',
    description:
      'Color Brewer is a tool for selecting color schemes for maps and data visualizations. It was developed by Cynthia Brewer (former Cartographer at ESRI) at Pennsylvania State University.',
  ...
  cartoColors: {
    ...
    name: 'CartoColor',
    description:
      'CartoColor is a color scheme library for maps. It is a collection of color schemes designed for cartography, and it is based on ColorBrewer 2.0.',
